...
import {dining} from "../../mock-data/mock-data-dining";
import Collection from "../shared/collections/collection";
  ...
  return (
    <div>
      ...
      <div className="max-width">
                <FeatureOptions featureList = {diningFeatures} />
            </div>
      <ExploreSection
